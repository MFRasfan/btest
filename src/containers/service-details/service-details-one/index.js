...
import ServiceSidebar from "@/containers/service-details/service-sidebar";

const serviceImage  = "/assets/images/bg/2.jpg";
    ...
    <div className="page-wrapper ptb--110">
      ...
      <div className="service-section">
        <div className="container">
          <div className="row">
            <div
              className={`col-lg-8 col-12 ${sidebarPosition && sidebarPosition === "left"
                  ? "order-1 order-lg-2"
                  : ""
                }`}
            >
            ...
            <div
              className={`col-lg-4 col-12 ${sidebarPosition && sidebarPosition === "left"
                  ? "order-2 order-lg-1"
                  : ""
                }`}
            >
